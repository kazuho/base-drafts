...
: All frames besides ACK, PADDING, CONNECTION_CLOSE, or APPLICATION_CLOSE are
...
* Packets that contain only ACK, CONNECTION_CLOSE, or APPLICATION_CLOSE frames
  do not count toward congestion control limits and are not considered
  in-flight.
